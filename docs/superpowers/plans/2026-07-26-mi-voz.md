...
| Servicio | Dónde | Guardar como |
|---|---|---|
| ElevenLabs Voice Isolator | elevenlabs.io → Voice Isolator | `pruebas/elevenlabs.mp3` |
| Dolby.io Media Enhance | dolby.io → Media Enhance | `pruebas/dolby.mp3` |
| Auphonic | auphonic.com (2 h gratis al mes) | `pruebas/auphonic.mp3` |

- [ ] **Paso 3: Anotar precio y política de datos de cada uno**

De cada servicio anotar: precio por minuto de audio, si **entrena modelos con lo que se le manda** (si lo hace, queda descartado por la sección 5 del spec), y si borra el archivo al terminar.
